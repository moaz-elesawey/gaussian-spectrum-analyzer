...
class Ui_SpectrumAnalyzer(object):
    def setupUi(self, SpectrumAnalyzer):
        ...
        self.open_file_btn.setMinimumSize(QtCore.QSize(180, 0))
        self.open_file_btn.setObjectName("open_file_btn")
        self.horizontalLayout_7.addWidget(self.open_file_btn)
        self.verticalLayout_4.addWidget(self.frame_3)
        self.spectrumStackedWidget = QtWidgets.QStackedWidget(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spectrumStackedWidget.sizePolicy().hasHeightForWidth())
        self.spectrumStackedWidget.setSizePolicy(sizePolicy)
        self.spectrumStackedWidget.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setFamily("Serif")
        self.spectrumStackedWidget.setFont(font)
        self.spectrumStackedWidget.setStyleSheet("QFrame#spectrumFrame{\n"
"    background-color: rgb(255, 255, 255);\n"
"}")
        self.spectrumStackedWidget.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.spectrumStackedWidget.setFrameShadow(QtWidgets.QFrame.Raised)
        self.spectrumStackedWidget.setObjectName("spectrumStackedWidget")
        ...
        self.spectrumStackedWidget.addWidget(self.spectrumFrame)
        self.renderFrame = QtWidgets.QWidget()
        self.renderFrame.setObjectName("renderFrame")
        self.renderLayout = QtWidgets.QVBoxLayout(self.renderFrame)
        self.renderLayout.setContentsMargins(0, 0, 0, 0)
        self.renderLayout.setSpacing(0)
        self.renderLayout.setObjectName("renderLayout")
        self.spectrumStackedWidget.addWidget(self.renderFrame)
        self.verticalLayout_4.addWidget(self.spectrumStackedWidget)
        ...
        self.pushButton_12.setMinimumSize(QtCore.QSize(150, 28))
        self.pushButton_12.setObjectName("pushButton_12")
        self.horizontalLayout_6.addWidget(self.pushButton_12)
        self.spectrum_btn = QtWidgets.QPushButton(self.frame_4)
        self.spectrum_btn.setMinimumSize(QtCore.QSize(0, 28))
        self.spectrum_btn.setObjectName("spectrum_btn")
        self.horizontalLayout_6.addWidget(self.spectrum_btn)
        self.render_btn = QtWidgets.QPushButton(self.frame_4)
        self.render_btn.setMinimumSize(QtCore.QSize(0, 28))
        self.render_btn.setObjectName("render_btn")
        self.horizontalLayout_6.addWidget(self.render_btn)
        ...
        self.spectrum_table = QtWidgets.QTableWidget(self.frame_2)
        ...
        self.verticalLayout_3.addWidget(self.spectrum_table)
    ...
    def retranslateUi(self, SpectrumAnalyzer):
        ...
        self.pushButton_12.setText(_translate("SpectrumAnalyzer", "Set custom frame"))
        self.spectrum_btn.setText(_translate("SpectrumAnalyzer", "Spectrum Graph"))
        self.render_btn.setText(_translate("SpectrumAnalyzer", "3D Render"))
        ...
        self.label.setText(_translate("SpectrumAnalyzer", "Band width on 1/2 height"))
