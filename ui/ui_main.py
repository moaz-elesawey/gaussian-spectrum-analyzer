...
class Ui_SpectrumAnalyzer(object):
    def setupUi(self, SpectrumAnalyzer):
        ...
        self.loaded_file_name.setIndent(20)
        ...
        self.spectrumFrame = QtWidgets.QFrame(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spectrumFrame.sizePolicy().hasHeightForWidth())
        self.spectrumFrame.setSizePolicy(sizePolicy)
        self.spectrumFrame.setMinimumSize(QtCore.QSize(0, 500))
        font = QtGui.QFont()
        font.setFamily("Serif")
        self.spectrumFrame.setFont(font)
        self.spectrumFrame.setStyleSheet("QFrame#spectrumFrame{\n"
"    background-color: rgb(255, 255, 255);\n"
"}")
        self.spectrumFrame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.spectrumFrame.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.verticalLayout_4.addWidget(self.spectrumFrame)
        ...
        self.broadening_slider.setProperty("value", 60)
    ...
    def retranslateUi(self, SpectrumAnalyzer):
        ...
        self.hide_verticals_check.setText(_translate("SpectrumAnalyzer", "Hide verticals"))
