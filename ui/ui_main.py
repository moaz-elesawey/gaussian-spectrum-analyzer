...
class Ui_SpectrumAnalyzer(object):
    def setupUi(self, SpectrumAnalyzer):
        ...
        self.spectrumFrame.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
...
"}")
    ...
    def retranslateUi(self, SpectrumAnalyzer):
        ...
        self.spectrums_select.setItemText(6, _translate("SpectrumAnalyzer", "NMR Spectrum"))
        self.spectrums_select.setItemText(7, _translate("SpectrumAnalyzer", "UV Vis Spectrum"))
